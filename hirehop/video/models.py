...
class channel_lists(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("video_channel_lists_detail", args=(self.ID,))

    def get_update_url(self):
        return reverse("video_channel_lists_update", args=(self.ID,))
...
class channel_list_input(models.Model):
    ...
    camera = models.TextField(max_length=100, blank=True, null=True)
    stand = models.TextField(max_length=100, blank=True, null=True)
...
class channel_list_output(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("video_channel_list_outputs_detail", args=(self.pk,))

    def get_update_url(self):
        return reverse("video_channel_list_outputs_update", args=(self.pk,))